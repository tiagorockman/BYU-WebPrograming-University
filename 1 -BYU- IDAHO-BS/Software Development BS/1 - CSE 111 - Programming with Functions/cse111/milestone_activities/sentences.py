...
def main():
    sentences_gen = ["single,past", "single,present", "single,future", "plural,past", "plural,present", "plural,future" ]
    for line in sentences_gen:
        columns = line.split(",")
        if columns[0] == "single":
            make_sentence(1, columns[1])
        else:
            make_sentence(2, columns[1])
...
def make_sentence(quantity, tense):
    ...
    adverb = get_adverb()
    print(f"{determiner.capitalize()} {noun} {prepositional_phrase} {adverb} {verb} {determiner} {noun} {prepositional_phrase2}.")
...
def get_prepositional_phrase(quantity):
    ...
    determiner = get_determiner(quantity)
    noun = get_noun(quantity)
    preposition  = f"{preposition} {determiner} {noun}"
    return preposition

# Exceeding the Requirements
def get_adverb():
    adverb = ["quickly", "slowly", "quietly", "loudly", "always", "never", "often", "rarely", "sometimes", "yesterday", "today", "tomorrow", "here", "there", "soon"]
